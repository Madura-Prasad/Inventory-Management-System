		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">Order Option</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentPlace" id="paymentPlace">
				      	<option value="">~~SELECT~~</option>
				      	<option value="Pending" <?php if($data[13] == 1) {
				      		echo "selected";
				      	} ?>  >Pending</option>
				      	<option value="Order Processing" <?php if($data[13] == 2) {
				      		echo "selected";
				      	} ?> >Order Processing</option>
							<option value="Dispatched" <?php if($data[13] == 3) {
				      		echo "selected";
				      	} ?> >Dispatched</option>
							<option value="Delivered" <?php if($data[13] == 4) {
				      		echo "selected";
				      	} ?> >Delivered</option>
				      </select>
				    </div>
