...
<body>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">      
      ...
      <ul class="nav navbar-nav navbar-right">        
		...
		<?php } ?>
    <?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
      <li id="topNavUser"><a href="user.php"> <i class="glyphicon glyphicon-user"></i> User</a></li>
		<?php } ?>
    <?php if(isset($_SESSION['userId']) && $_SESSION['userId']==1) { ?>
      <li id="topNavUser0"><a href="request.php"> <i class="glyphicon glyphicon-shopping-cart"></i> Request Order</a></li>
		<?php } ?>
