...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
	...
	if($row[5]) { 	
		if ($row[5] == 1) {
			$paymentplace = "<label class='label label-success'>Pending</label>";
		} else if ($row[5] == 2) {
			$paymentplace = "<label class='label label-success'>Order Processing</label>";
		} else if ($row[5] == 3) {
			$paymentplace = "<label class='label label-success'>Dispatched</label>";
		} else if ($row[5] == 4) {
			$paymentplace = "<label class='label label-success'>Deliver</label>";
		} else {
			$paymentplace = "<label class='label label-success'>$row[5]</label>";
		}	
