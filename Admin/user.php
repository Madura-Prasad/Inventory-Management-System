    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitUserForm" action="php_action/createUser.php" method="POST" enctype="multipart/form-data">
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
			...
			<div class="form-group">
	        	<label for="umobile" class="col-sm-3 control-label">Mobile Number: </label>
	        	
				    <div class="col-sm-8">
				      <input type="number" class="form-control" id="umobile" placeholder="Mobile Number" name="umobile" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->

			<div class="form-group">
	        	<label for="uaddress" class="col-sm-3 control-label">Address: </label>
	        	
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="uaddress" placeholder="Address" name="uaddress" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->
	      	...
	      	<div class="div-result">
				  ...
				  <div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="userInfo">
						...
						<div class="form-group">
			        		<label for="editMobile" class="col-sm-3 control-label">Mobile: </label>
			        	
						    <div class="col-sm-8">
						      <input type="text" class="form-control" id="editMobile" placeholder="Mobile" name="editMobile" autocomplete="off">
						    </div>
			        	</div> <!-- /form-group-->
